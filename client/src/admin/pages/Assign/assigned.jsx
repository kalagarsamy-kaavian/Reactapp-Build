...
export default function Assigned() {
    ...
    function func() {
        ...
        fetch(`http://localhost:3002/assignemprecord`, { method: 'post', body: JSON.stringify({mem,memt,memr,memf,meme,pn,tn,d,start,end,pco,es,descr,pt}), headers: { 'content-type': 'application/json' } })
       else
    ...
    <tbody>        
        ...
        <tr><td>Duration</td><input type="text" onChange={(e) => setD(e.target.value)} placeholder='Platform' required></input></tr>
        <tr><td>Starting Date</td><input type="date" onChange={(e) => setStart(e.target.value)} placeholder='EmpDOB' required></input></tr>
        <tr><td>Ending Date</td><input type="date" onChange={(e) => setEnd(e.target.value)} placeholder='EmpDOB' required></input></tr>
        ...
        <tr><td>Description</td><input type="date" onChange={(e) => setDescr(e.target.value)} placeholder='EmpDateOfJoining' required></input></tr>
